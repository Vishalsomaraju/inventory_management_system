        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-slate-200 text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {alerts.map((alert) => (
                <tr key={alert.id}>
                  <td className="px-4 py-3 font-medium text-slate-900">{alert.product_name}</td>
                  <td className="px-4 py-3 text-slate-600">{alert.sku}</td>
                  <td className="px-4 py-3 text-slate-600">{alert.current_stock}</td>
                  <td className="px-4 py-3 text-slate-600">{alert.reorder_level}</td>
